...
export const NodeJsProxy = async (rq: NextRequest) => {
...
export const EdgeProxy = async (req: Request) => {
    const url = new URL(req.url).searchParams.get('url');

    if (!url) return new Response("URL is not provided. URL of the destination must be provided in the searchParams under the name 'url'.")
